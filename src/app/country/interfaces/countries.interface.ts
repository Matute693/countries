...
//
//   const responseCountriesResponse = Convert.toResponseCountriesResponse(json);
//
...
export class Convert {
    public static toResponseCountriesResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("ResponseCountriesResponse")));
    }

    public static responseCountriesResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("ResponseCountriesResponse"))), null, 2);
    }
}
